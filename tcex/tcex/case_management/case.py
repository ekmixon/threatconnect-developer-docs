...
class Case(CommonCaseManagement):
    ...
    def __init__(self, tcex, **kwargs):
        ...
        self._artifacts = kwargs.get('artifacts')
        ...
        self._severity = kwargs.get('severity')
        self._status = kwargs.get('status')
        self._tags = kwargs.get('tags')
        self._tasks = kwargs.get('tasks')
        self._user_access = kwargs.get('user_access')
        self._workflow_events = kwargs.get('workflow_events')
        self._workflow_template = kwargs.get('workflow_template')
